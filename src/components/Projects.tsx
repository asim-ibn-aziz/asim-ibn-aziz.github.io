...
const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ["Laravel", "MySQL", "JavaScript", "Tailwind CSS", "React"],
  ...
  },
  {
    ...
    technologies: ["Laravel", "MySQL", "React", "Tailwind CSS", "JavaScript"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Explore my latest work and innovative solutions that solve
            real-world problems
          </p>
        </div>
