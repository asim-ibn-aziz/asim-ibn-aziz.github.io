...
export const MacbookScroll = ({
    ...
    return (
        <motion.div
            ...
            className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-50 [perspective:800px] sm:scale-50 sm:py-0 md:scale-100 md:py-60"
        >
            <motion.h2
                style={{
...
export const Lid = ({
    ...
    return (
        <div className="relative [perspective:800px]">
            ...
            >
                <div className="absolute inset-0 rounded-xl bg-[#272729]" />
                <img
                    src={src as string}
                    alt="fabicode logo"
